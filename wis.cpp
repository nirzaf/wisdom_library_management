...
void main()
{
	...
	do {
		...
		case 0:		{
					...
					float mints = seconds / 60;
					cout << "\n\tTotal time of wisdom enquiry system used for " << mints << " Minutes " << endl;
					adminduration << seconds / 3600 << endl;
					cout << "\n\tWelcome Again\n\n\n\n";
					system("pause");
					return; }
...
void changepw()
{
	ifstream adminin, staffin;
	ofstream adminout, staffout;
	adminin.open("admin.txt");
	staffin.open("user.txt");
	adminout.open("admin.txt");
	staffout.open("user.txt");
	string usern[100], pw[100], id1, pw1, pw2;
	int x;
	do {
		cout << "\n\t1. Change admin password" << endl;
		cout << "\n\t2. Change staff password" << endl;
...
void adminMenu(ofstream& adminloginreport)
{
	...
	do {
		...
		case 0: {
				...
				float duration((float)t2 - (float)t1);
				float seconds = duration / CLOCKS_PER_SEC;
				cout << "\n\tDear Admin of Wisdom!!!..\n\tYou have spent " << seconds << " seconds with Wisdom's enquiry system" << endl;
				cout << "\n\tSee you Soon......" << endl;
				system("pause");
				return;
				}break;
...
void staffFunctions(string name, ofstream& loginreport, ofstream& guestlogin)
{
	...
	do {
		...
		case 0: {if (name == "Guest")
				...
				float duration((float)t2 - (float)t1);
				float seconds = duration / CLOCKS_PER_SEC;
				cout <<"\n\tDear guest of Wisdom!!!..\n\tThank you for spent your precious "<< seconds <<" seconds with us"<< endl;
				cout << "\n\tWelcome back soon again......!\n\n\n\n\n\n\t\t" << endl;
				guestdur << seconds / 3600 << endl;
				system("pause");
				return;
				}
				else
...
{
	system("cls");
	ifstream admin, staff, guest,admindu,staffdu,guestdu;
	...
	do {
		...
		else if (x == 4)
		{
			...
			if(file == true)
				cout << "\n\n\tTotal hours used by admin : " << total << endl;
			if (!file)
			{
				cout << "\n\tNo Login Reports found" << endl;
				break;
		...
		else if (x == 5)
		{
			...
			if (file == true)
			cout << "\n\n\tTotal hours used by staffs : " << total << endl;
			if (!file)
			{
				cout << "\n\tNo Login Reports found" << endl;
				break;
		...
		else if (x == 7)
		{
			...
			if (file == true)
				cout << "\n\n\tOverall Total hours used : " << total << endl;
			if (!file)
			{
				cout << "\n\tNo Login Reports found" << endl;
				break;
